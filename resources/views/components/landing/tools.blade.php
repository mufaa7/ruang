        ...
        <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 60px 80px;">
            ...
            <div style="display: flex; gap: 30px; align-items: flex-start; border-top: 1px solid rgba(255,255,255,0.1); padding-top: 30px;">
                ...
                <div>
                    ...
                    <p style="color:var(--secondary); font-size:18px; line-height:1.8; margin:0;">
                        Tidak perlu lagi menatap layar kosong. Masukkan judulmu, dan biarkan AI menyusun kerangka, pendahuluan, hingga kesimpulan secara instan.
                    </p>
                </div>
            </div>
            ...
            <div style="display: flex; gap: 30px; align-items: flex-start; border-top: 1px solid rgba(255,255,255,0.1); padding-top: 30px;">
                ...
                <div>
                    ...
                    <p style="color:var(--secondary); font-size:18px; line-height:1.8; margin:0;">
                        Kumpulkan materimu dan ubah menjadi latihan interaktif. Uji pemahamanmu secara berkala tanpa harus membuat soal sendiri.
                    </p>
                </div>
            </div>
            ...
            <div style="display: flex; gap: 30px; align-items: flex-start; border-top: 1px solid rgba(255,255,255,0.1); padding-top: 30px;">
                ...
                <div>
                    ...
                    <p style="color:var(--secondary); font-size:18px; line-height:1.8; margin:0;">
                        Perlu bantuan meringkas panjangnya referensi? Asisten AI siap membantu melanjutkan kalimatmu, meringkas teks, atau mencari rujukan.
                    </p>
                </div>
            </div>
            ...
            <div style="display: flex; gap: 30px; align-items: flex-start; border-top: 1px solid rgba(255,255,255,0.1); padding-top: 30px;">
                ...
                <div>
                    ...
                    <p style="color:var(--secondary); font-size:18px; line-height:1.8; margin:0;">
                        Temukan ritme belajarmu. Sambungkan akun Spotify dan kendalikan playlist andalanmu tanpa harus berpindah aplikasi.
                    </p>
                </div>
            </div>
        </div>
