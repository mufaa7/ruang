        ...
        <div class="dev-card p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                ...
                <div>
                    ...
                    <input type="text" name="title" value="{{ old('title', $quiz->title) }}" required class="w-full border border-black p-2 text-sm focus:outline-none focus:ring-0 focus:border-black" placeholder="e.g. Midterm Physics">
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6" x-show="selectedSubjectId" x-transition>
                ...
                <div>
                    ...
                    <input type="number" name="time_limit_minutes" value="{{ old('time_limit_minutes', $quiz->time_limit_minutes) }}" min="1" class="w-full border border-black p-2 text-sm focus:outline-none focus:ring-0 focus:border-black">
                </div>
            </div>
