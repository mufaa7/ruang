        ...
        <div class="flex-1 max-w-2xl">
            ...
            <div x-show="activeTab === 'tampilan'" class="p-6 bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-sm space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <button @click="setTheme('light')" :class="theme === 'light' ? 'border-indigo-600 ring-1 ring-indigo-600 bg-indigo-50/50 dark:bg-indigo-500/10' : 'border-slate-200 dark:border-slate-700 hover:border-indigo-300'" class="flex flex-col items-center gap-3 p-4 border rounded-xl transition-all">
                    ...
                    <button @click="setTheme('dark')" :class="theme === 'dark' ? 'border-indigo-600 ring-1 ring-indigo-600 bg-indigo-50/50 dark:bg-indigo-500/10' : 'border-slate-200 dark:border-slate-700 hover:border-indigo-300'" class="flex flex-col items-center gap-3 p-4 border rounded-xl transition-all">
                    ...
                    <button @click="setTheme('system')" :class="theme === 'system' ? 'border-indigo-600 ring-1 ring-indigo-600 bg-indigo-50/50 dark:bg-indigo-500/10' : 'border-slate-200 dark:border-slate-700 hover:border-indigo-300'" class="flex flex-col items-center gap-3 p-4 border rounded-xl transition-all">
